...
<input name="csrf_token" type="hidden" value="<?= app()->auth::generateCSRF() ?>"/>
       <select name="doctor_id" class=" flex justify-center gap-4 bg-neutral-300 text-black m-4 p-2 rounded-full w-96 text-lg">
       <?php
foreach ($Doctors as $Doctors) {
        ...
        echo" <select name=\" patient_id\"  class=\" flex justify-center gap-4 bg-neutral-300 text-black m-4 p-2 rounded-full w-96 text-lg\">";
